...
const ContactUs = () => {
    ...
    formData.append("access_key", "4851cecc-65e6-4b39-bfde-13648d368483");
  ...
  return (
    ...
    id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      <Tittle tittle='Reach out to us' desc='Have questions about deepfake detection? Get in touch with us and we’ll help you verify digital content with confidence.'/>
      ...
      onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
        ...
        <button type='submit' className='w-max flex gap-2 bg-primary text-white text-sm px-10 py-3 rounded-full cursor-pointer transition-all hover:scale-103' >
